...
def main():
    while True:
        try:
            ...
            # This catches the error that happens after "3 seconds" of nothing
            console.print("\n\n" + Align.center("[bold yellow]⚠ System Interrupted. Returning to main menu...[/]"))
            time.sleep(1)
            continue # Restarts the loop instead of crashing
        except EOFError:
            # This happens if the terminal is closed unexpectedly
            break
